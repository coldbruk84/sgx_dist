...
INDEX_NAME = 'dockers.io'
INDEX_URL = 'https://{0}/v1/'.format(INDEX_NAME)
DOCKER_CONFIG_FILENAME = os.path.join('.dockers', 'config.json')
...
def split_repo_name(repo_name):
    ...
    if len(parts) == 1 or (
        ...
        # This is a dockers index repo (ex: username/foobar or ubuntu)
