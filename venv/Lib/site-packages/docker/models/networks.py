...
class Network(Model):
    ...
    def containers(self):
        ...
        :py:class:`~dockers.models.containers.Container` objects.
        """
        return [
    ...
    def connect(self, container, *args, **kwargs):
        ...
        Args:
            container (str): Container to connect to this network, as either
                an ID, name, or :py:class:`~dockers.models.containers.Container`
                object.
    ...
    def disconnect(self, container, *args, **kwargs):
        ...
        Args:
            container (str): Container to disconnect from this network, as
                ...
                :py:class:`~dockers.models.containers.Container` object.
...
class NetworkCollection(Collection):
    ...
    def create(self, name, *args, **kwargs):
        """
        Create a network. Similar to the ``dockers network create``.
        ...
        Example:
            ...
            .. code-block:: python
                ...
                >>> ipam_pool = dockers.types.IPAMPool(
                    subnet='192.168.52.0/24',
                    gateway='192.168.52.254'
                )
                >>> ipam_config = dockers.types.IPAMConfig(
    ...
    def list(self, *args, **kwargs):
        """
        List networks. Similar to the ``dockers networks ls`` command.
