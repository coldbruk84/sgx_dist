import copy
from dockers.errors import create_unexpected_kwargs_error, InvalidArgument
from dockers.types import TaskTemplate, ContainerSpec, Placement, ServiceMode
...
class Service(Model):
    ...
    def update(self, **kwargs):
        """
        Update a service's configuration. Similar to the ``dockers service
        update`` command.
...
class ServiceCollection(Collection):
    ...
    def create(self, image, command=None, **kwargs):
        """
        Create a service. Similar to the ``dockers service create`` command.

        Args:
            image (str): The image name to use for the containers.
            command (list of str or str): Command to run.
            args (list of str): Arguments to the command.
            constraints (list of str): :py:class:`~dockers.types.Placement`
                constraints.
            preferences (list of tuple): :py:class:`~dockers.types.Placement`
                preferences.
            ...
            networks (:py:class:`list`): List of network names or IDs or
                :py:class:`~dockers.types.NetworkAttachmentConfig` to attach the
                service to. Default: ``None``.
            resources (Resources): Resource limits and reservations.
            restart_policy (RestartPolicy): Restart policy for containers.
            secrets (list of :py:class:`~dockers.types.SecretReference`): List
            ...
            configs (:py:class:`list`): List of
                :py:class:`~dockers.types.ConfigReference` that will be exposed
                to the service.
    ...
    def get(self, service_id, insert_defaults=None):
        ...
        Raises:
            ...
            :py:class:`dockers.errors.APIError`
                If the server returns an error.
            :py:class:`dockers.errors.InvalidVersion`
