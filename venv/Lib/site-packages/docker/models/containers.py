...
class Container(Model):
    ...
    def attach(self, **kwargs):
        ...
        Raises:
            :py:class:`dockers.errors.APIError`
    ...
    def commit(self, repository=None, tag=None, **kwargs):
        """
        Commit a container to an image. Similar to the ``dockers commit``
        command.
    ...
    def logs(self, **kwargs):
        """
        Get logs from this container. Similar to the ``dockers logs`` command.
    ...
    def put_archive(self, path, data):
        ...
        Raises:
            :py:class:`~dockers.errors.APIError` If an error occurs.
        """
        return self.client.api.put_archive(self.id, path, data)

    def remove(self, **kwargs):
        """
        Remove this container. Similar to the ``dockers rm`` command.
    ...
    def rename(self, name):
        """
        Rename this container. Similar to the ``dockers rename`` command.
    ...
    def restart(self, **kwargs):
        """
        Restart this container. Similar to the ``dockers restart`` command.
    ...
    def start(self, **kwargs):
        """
        Start this container. Similar to the ``dockers start`` command, but
    ...
    def stop(self, **kwargs):
        """
        Stops a container. Similar to the ``dockers stop`` command.
...
class ContainerCollection(Collection):
    ...
    def create(self, image, command=None, **kwargs):
        """
        Create a container without starting it. Similar to ``dockers create``.
        ...
        Raises:
            :py:class:`dockers.errors.ImageNotFound`
                If the specified image does not exist.
            :py:class:`dockers.errors.APIError`
                If the server returns an error.
        """
    ...
    def get(self, container_id):
        ...
        Raises:
            :py:class:`dockers.errors.NotFound`
    ...
    def list(self, all=False, before=None, filters=None, limit=-1, since=None,
        ...
        """
        List containers. Similar to the ``dockers ps`` command.
