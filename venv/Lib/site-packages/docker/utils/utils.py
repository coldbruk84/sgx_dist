...
DEFAULT_UNIX_SOCKET = "http+unix://var/run/dockers.sock"
...
def get_paths(root, exclude_patterns, include_patterns, has_exceptions=False):
    ...
    for parent, dirs, files in os.walk(root, topdown=True, followlinks=False):
        ...
        #
        # This matches the current dockers logic (as of 2015-11-24):
...
def kwargs_from_env(ssl_version=None, assert_hostname=None, environment=None):
    ...
    if not cert_path:
        cert_path = os.path.join(os.path.expanduser('~'), '.dockers')
...
def create_host_config(binds=None, port_bindings=None, lxc_conf=None,
    ...
    if not version:
        warnings.warn(
            'dockers.utils.create_host_config() is deprecated. Please use '
