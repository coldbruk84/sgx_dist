...
from dockers.tls import TLSConfig
from dockers.errors import ContextException
from dockers.context.config import get_meta_dir
from dockers.context.config import get_meta_file
from dockers.context.config import get_tls_dir
from dockers.context.config import get_context_host
...
class Context:
    ...
    def __init__(self, name, orchestrator=None, host=None, endpoints=None,
        ...
        if not endpoints:
            # set default dockers endpoint if no endpoint is set
            default_endpoint = "dockers" if (
    ...
    def set_endpoint(
            self, name="dockers", host=None, tls_cfg=None,
    ...
    def _load_meta(cls, name):
        ...
        # for dockers endpoints, set defaults for
    ...
    def Host(self):
        if not self.orchestrator or self.orchestrator == "swarm":
            endpoint = self.endpoints.get("dockers", None)
            if endpoint:
