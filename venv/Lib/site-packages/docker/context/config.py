...
from dockers import utils
from dockers.constants import IS_WINDOWS_PLATFORM
from dockers.constants import DEFAULT_UNIX_SOCKET
from dockers.utils.config import find_config_file
...
def get_context_host(path=None, tls=False):
    ...
    if host == DEFAULT_UNIX_SOCKET:
        # remove http+ from default dockers socket url
